...
class SmartBooksGUI:
    def __init__(self, root):
        ...
        # Inladen in geheugen bij opstarten
    ...
    def draw_menu(self):
        ...
        for t, c in btns:
            tk.Button(self.sidebar, text=t, command=c, bg="#2d2d44", fg="white", relief="flat", pady=8).pack(fill="x", padx=10, pady=2)
    ...
    def page_users(self):
        ...
        tree.heading("C", text="ID"); tree.heading("N", text="Naam"); tree.heading("B", text="Geleende Boeken")
        tree.pack(fill="both", expand=True, padx=20, pady=10)
    ...
    def page_lend(self):
        ...
        tk.Label(self.content, text="User Code:").pack(); u_ent = tk.Entry(self.content); u_ent.pack()
        tk.Label(self.content, text="Boek Code:").pack(); b_ent = tk.Entry(self.content); b_ent.pack()
        ...
        def do():
            ...
            if books.update_status(b_c, "Uitgeleend", due):
                ...
                messagebox.showinfo("Succes", "Geregistreerd in geheugen!")
                self.page_books()
            else: messagebox.showerror("Fout", "Niet gevonden")
    ...
    def page_return(self):
        ...
        def do():
            ...
            if users.manage_loan(u_c, b_c, "remove"):
                ...
                messagebox.showinfo("Succes", "Teruggebracht in geheugen!")
                self.page_books()
            else: messagebox.showerror("Fout", "Niet gevonden")
...
def start_gui():
    ...
    def on_closing():
        # ALLES IN 1X OPSLAAN BIJ SLUITEN
        books.save_to_disk()
        users.save_to_disk()
        root.destroy()
